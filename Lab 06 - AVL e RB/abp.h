...
/** \brief Dada uma árvore/subárvore determinada pelo ponteiro entrado, retorna a altura de dado nodo em um ABP
 *
...
/** \brief Consulta uma arvore binaria de pesquisa
 *
 * \param *a - Ponteiro do tipo pNodo para a raiz da arvore
 * \param chave - inteiro do tipo tipoinfo que sera buscado na arvore
 * \return
